...
(assert (distinct sort_any sort_Null sort_Heap sort_boolean sort_int sort_java.lang.Object sort_Field))
...
; --- Sequent
(assert (not (and (and (and (= u_x u_a) (= u_y u_b)) (= u_z u_c)) (k_wellFormed u_heap))))
