...
(declare-fun u_z () U)
(declare-fun |u_Helper::pow2| (U U U) U)
...
(assert (distinct sort_Heap sort_boolean sort_int))
...
(assert (forall ((var_0 U) (var_1 U) (var_2 U)) (! (instanceof (|u_Helper::pow2| var_0 var_1 var_2) sort_int) :pattern ((|u_Helper::pow2| var_0 var_1 var_2)))))
...
; --- Sequent
(assert (not (= (i2u (* (u2i u_z) (u2i (|u_Helper::pow2| u_heap u_b u_i)))) (|u_Helper::pow2| u_heap u_a u_n))))
