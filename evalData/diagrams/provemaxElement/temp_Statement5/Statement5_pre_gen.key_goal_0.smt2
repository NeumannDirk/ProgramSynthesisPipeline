...
(assert (distinct sort_int sort_Field sort_Heap sort_boolean sort_Null |sort_int[]| sort_any sort_java.lang.Object))
...
; --- Sequent
(assert (not (and (and (and (and (and (and (and (and (and (and (forall ((var_q Int)) (or (not (and (>= var_q 0) (< var_q (+ (u2i u_j) 1)))) (>= (u2i (cast (k_select u_heap u_A (arr u_i)) sort_int)) (u2i (cast (k_select u_heap u_A (arr (i2u var_q))) sort_int))))) (not (= u_A k_null))) (> (u2i (k_length u_A)) 0)) (< (u2i (k_length u_A)) 10)) (>= (u2i u_i) 0)) (< (u2i u_i) (u2i (k_length u_A)))) (>= (u2i u_j) 0)) (<= (u2i u_j) (u2i (k_length u_A)))) (= (cast (k_select u_heap u_A |field_java.lang.Object::<created>|) sort_boolean) (b2u true))) (= (cast (k_select u_heap u_A_old |field_java.lang.Object::<created>|) sort_boolean) (b2u true))) (k_wellFormed u_heap))))
