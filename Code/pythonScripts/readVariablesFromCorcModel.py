...
def parse_java_variables(root, namespace):
    ...
    if java_variables_node is not None:
        ...
        java_variables_dict = {}
        for variable_node in java_variables_node.findall(".//variables", namespaces=namespace):            
...
def parse_modifiables_list(root, node_id_to_find, namespace):
    ...
    if found_node is not None:
        ...
        if post_condition_node is not None:
            for modifiable_node in post_condition_node.findall(".//modifiables", namespaces=namespace):
...
if __name__ == "__main__":
    file_path_param = ".\\..\\..\\ExampleProblemDefinitions\\xPlusOne\\newDiagram.cbcmodel"
